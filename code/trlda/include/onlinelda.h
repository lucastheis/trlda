...
inline Eigen::ArrayXd TRLDA::OnlineLDA::alpha() const {
	return mAlpha;
}



inline void TRLDA::OnlineLDA::setAlpha(double alpha) {
	if(alpha < 0.)
...
inline void TRLDA::OnlineLDA::setAlpha(const ArrayXd& alpha) {
...
inline double TRLDA::OnlineLDA::eta() const {
	return mEta;
}



inline void TRLDA::OnlineLDA::setEta(double eta) {
	if(eta < 0.)
...
inline Eigen::ArrayXXd TRLDA::OnlineLDA::lambda() const {
	return mLambda;
}



inline void TRLDA::OnlineLDA::setLambda(const ArrayXXd& lambda) {
...
inline int TRLDA::OnlineLDA::numTopics() const {
	return mLambda.rows();
}



inline int TRLDA::OnlineLDA::numWords() const {
	return mLambda.cols();
}
