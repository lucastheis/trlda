#ifndef TRLDA_UTILS_H
#define TRLDA_UTILS_H
...
#define TRLDA_PI 3.141592653589793238462643383279502884
#define TRLDA_EULER 0.577215664901532860606512090082402431
...
template <class ArrayType>
ArrayType TRLDA::concatenate(const vector<ArrayType>& data, int axis) {
	if(data.size()) {
		if(axis == 1) {
			int cols = 0;
