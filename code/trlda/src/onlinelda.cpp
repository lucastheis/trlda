...
TRLDA::OnlineLDA::Parameters::Parameters(
...
TRLDA::OnlineLDA::Documents TRLDA::OnlineLDA::sample(int numDocuments, double length) {
	Documents documents;
...
pair<ArrayXXd, ArrayXXd> TRLDA::OnlineLDA::updateVariables(
...
pair<ArrayXXd, ArrayXXd> TRLDA::OnlineLDA::updateVariablesVI(
		const Documents& documents,
...
pair<ArrayXXd, ArrayXXd> TRLDA::OnlineLDA::updateVariablesGibbs(
		const Documents& documents,
