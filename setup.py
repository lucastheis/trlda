...
modules = [
	Extension('_trlda',
		language='c++',
		sources=[
				'code/trlda/src/lda.cpp',
				'code/trlda/src/onlinelda.cpp',
				'code/trlda/src/batchlda.cpp',
				'code/trlda/src/cumulativelda.cpp',
				...
				'code/trlda/python/src/ldainterface.cpp',
				'code/trlda/python/src/onlineldainterface.cpp',
				'code/trlda/python/src/batchldainterface.cpp',
				'code/trlda/python/src/cumulativeldainterface.cpp',
